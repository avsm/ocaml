...
let descriptions = [
  ...
  { number = 76;
    names = ["doc-comment"];
    description = "Syntax error or warning in the body of a documentation \
                   comment.";
    since = since 5 6 };
]
...
let defaults_w = "+a-4-7-9-27-29-30-32..42-44-45-48-50-60-66..70-74-76"
